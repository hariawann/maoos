...
<body>
	...
	<form method="Post" action="<?php echo baseUrl();?>/user/store">
		id<input name="id" value="<?php echo isset($user->id) ? $user->id : null;  ?>" type="number" ></br>
		...
		tgl buat<input name="dibuat" value="<?php mytime()->now()  ?>" type="date" readonly>
